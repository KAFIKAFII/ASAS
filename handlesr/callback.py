...
def updateCallback(client, callback_query,redis):
  ...
  if group is True and int(date[2]) == userID and not redis.get("{}Nbot:floodUsers:{}".format(BOT_ID,userID)):
    ...
    if date[0] == "ShowDateUser":
      ...
      age = getAge(userID,r)
      reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(Name(userFN),url="t.me/U_24U")],[InlineKeyboardButton(r.Rrank.format(t),url="t.me/U_24U")],[InlineKeyboardButton(r.Rmsgs.format(msgs),url="t.me/U_24U")],[InlineKeyboardButton(r.Rrate.format(str(rate)+"%"),url="t.me/U_24U")],[InlineKeyboardButton(r.Redits.format(edits),url="t.me/U_24U")],[InlineKeyboardButton(r.Rage.format(age),url="t.me/U_24U")]])
