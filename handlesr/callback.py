...
def updateCallback(client, callback_query,redis):
  ...
  if group is True and int(date[2]) == userID and not redis.get("{}Nbot:floodUsers:{}".format(BOT_ID,userID)):
    ...
    if date[0] == "dlf":
      File = date[1]
      os.system("rm ./files/"+File)
      url = "https://raw.githubusercontent.com/KAFIKAFII/IDAFATT/master/"+File
    ...
    if date[0] == "ShowDateUser":
      ...
      age = getAge(userID,r)
      reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(Name(userFN),url="t.me/HH_418")],[InlineKeyboardButton(r.Rrank.format(t),url="t.me/HH_418")],[InlineKeyboardButton(r.Rmsgs.format(msgs),url="t.me/HH_418")],[InlineKeyboardButton(r.Rrate.format(str(rate)+"%"),url="t.me/HH_418")],[InlineKeyboardButton(r.Redits.format(edits),url="t.me/HH_418")],[InlineKeyboardButton(r.Rage.format(age),url="t.me/HH_418")]])
