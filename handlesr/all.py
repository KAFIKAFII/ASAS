...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/U_24U")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/So_rsbot")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/rr_200r")]])
