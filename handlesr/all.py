...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("𝙎𝙊𝙐𝙍𝘾𝙀 𝘾𝘼𝙃𝙃𝙉𝙀𝙇", url="t.me/")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/IBOIBO100")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/HH_418")]])
