...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/HH_418")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/IBOIBO100")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/HH_418")]])
